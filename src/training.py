import os
from mivia_dataset import MiviaDataset
...
dir_model = getProjectRoot() / 'models'
...
def main():
    ...
    if IN_COLAB:
        ...
        dataset_path = getProjectRoot() / 'dataset' / 'data' / 'training_set'
    # ----- dataset and dataloader -----

    train_csv = getProjectRoot() / 'dataset' / 'annotations' /  'annotation_training.csv'
    validation_csv = getProjectRoot() / 'dataset' / 'annotations' /  'annotation_validation.csv'
